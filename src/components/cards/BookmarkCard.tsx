...
export default function BookmarkCard({ clip }: { clip: Clip }) {
  ...
  return (
    <div className="group flex h-full flex-col justify-center gap-2 overflow-hidden rounded-xl bg-bg-card/60 backdrop-blur-xl border border-white/[0.06] p-3.5 transition-all hover:shadow-[0_0_20px_#FF6EC720]">
