...
export default function NoteCard({ clip }: { clip: Clip }) {
  return (
    <div className="group flex h-full flex-col gap-1.5 overflow-hidden rounded-xl border border-[#FF6EC720] bg-bg-card/60 backdrop-blur-xl p-3.5 transition-all hover:shadow-[0_0_20px_#FF6EC720]">
